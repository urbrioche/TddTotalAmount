...
namespace TddTotalAmount
{
    ...
    public class TotalAmountTest
    {
        ...
        {
            GivenBudgets(new Budget() { YearMonth = "201804", Amount = 30 });
            TotalAmountShouldBe(1, new DateTime(2018, 5, 30), new DateTime(2018, 5, 1));
        }
        ...
        private void GivenBudgets(params Budget[] expected)
        {
            _repository.GetAll().Returns(expected.ToList());
        }
    }
}