...
namespace TddTotalAmount
{
    ...
    public class TotalAmountTest
    {
        ...
        [TestMethod]
        public void no_effective_day_period_before_budget_month_FirstDay()
        {
            GivenBudgets(new Budget() { YearMonth = "201804", Amount = 30 });
        ...
        [TestMethod]
        public void no_effective_day_period_after_budget_month_LastDay()
        {
            GivenBudgets(new Budget() { YearMonth = "201804", Amount = 30 });
        ...
        [TestMethod]
        public void one_effective_day_period_overlap_budget_momth_FirstDay()
        {
            GivenBudgets(new Budget() { YearMonth = "201804", Amount = 30 });
        ...
        [TestMethod]
        public void one_effective_day_period_overlap_budget_momth_LastDay()
        {
            GivenBudgets(new Budget() { YearMonth = "201804", Amount = 30 });
